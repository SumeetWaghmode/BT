...
if /i "%BT_ENV%" == "int"  set ORACLE_SID=%ORACLE_SID_PROD%
...
if /i "%BT_PLM_SITE%" == "RAS" (
	...
	set SPLM_SHR_DIR=\\deras900.de-ras.de.abatos.com\plmshare112
)

:: # Zug
if /i "%BT_PLM_SITE%" == "ZUG" (
	set BT_UG_SERVER=chlupi99003srv.ad001.siemens.net
	set SPLM_SHR_DIR=\\chlupi99003srv.ad001.siemens.net\plmshare112
)

:: # Peking
if /i "%BT_PLM_SITE%" == "PEK" (
	set BT_UG_SERVER=CNPEK01343.ad001.siemens.net
	set SPLM_SHR_DIR=\\CNPEK01343.ad001.siemens.net\plmshare112
)

:: # Kimpo
if /i "%BT_PLM_SITE%" == "KPO" (
	set BT_UG_SERVER=kr001s1052srv.kr001.siemens.net
	set SPLM_SHR_DIR=\\kr001s1052srv.kr001.siemens.net\plmshare112
)

:: # Buffalo Grove	
if /i "%BT_PLM_SITE%" == "BFG" (
	set BT_UG_SERVER=uslzua200kpsrv.ad001.siemens.net
	set SPLM_SHR_DIR=\\uslzua200kpsrv.ad001.siemens.net\plmshare112
)
