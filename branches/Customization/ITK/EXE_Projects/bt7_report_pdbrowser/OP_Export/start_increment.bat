...
call bt7_report_pdbrowser.exe -u=%USR% -p=%PWD% -g=%GRP% -export_history=%EXPORT_HISTORY% -document_list=%DOCUMENT_LIST% -root_export_dir=%ROOT_EXPORT_DIR% -mode=increment
