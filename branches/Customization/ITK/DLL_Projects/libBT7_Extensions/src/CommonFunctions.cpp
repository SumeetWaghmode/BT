...
logical lDisableRule(logical lNeedByPass)
{
	...
	tag_t	tCurrentGroup			= NULLTAG;//merged changes from LMTec for R1.4.2
	char*	sGroupName				= "";//merged changes from LMTec for R1.4.2
	...
	ITK_CALL( SA_ask_groupmember_group( tCurrentGroupMember, &tCurrentGroup ) );//merged changes from LMTec for R1.4.2
	
	
	ITK_CALL( SA_ask_group_name2( tCurrentGroup, &sGroupName ) );//merged changes from LMTec for R1.4.2
	

	// Current group is 'dba' or '100_Admin'? 
