...
public class PRIONDSPDatasetBean {
    ...
    public PRIONDSPDatasetBean(PRIONDSPDatasetBean x) {
       ...
       this.translatedDatasetRelationWithIR = new String(x.translatedDatasetRelationWithIR);
       this.translatedFileExtension = new String(x.translatedFileExtension);
       this.translatedFileReferenceType = new String(x.translatedFileReferenceType);
