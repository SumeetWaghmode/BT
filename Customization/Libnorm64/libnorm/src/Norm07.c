...
/*      ƒnderung            am 05.10.01 Warnungen beseitigt  Androleit        */
/* -------------------------------------------------------------------------- */
...
#endif
{
   ...
   size_t       i,k,ab;
   size_t       a[14];   /*    krachts 'ba21.02.2003 arno m¸ﬂte 13 sein */
   char      feld0[27];
   char      *feld0_1=feld0;
   char      vergleich[2];
...
/* hier erfolgt die Belegung der Zeiger fÅr atoi
 ...
 /*    krachts ba21.02.2003 arno m¸ﬂte 13 sein */
	for (i=0;i<14;i++)                           
    {
	      a[i] = atoi(feld0_1);  
	      *feld0_1=feld0[k];  
